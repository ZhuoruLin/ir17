...
\textbf{Solutions:}
\\
The results is shown in Figure \ref{fig:p3-ptf}. With a higher error rate, the model have only limited ability to decode and cannot restore the original image.
\begin{figure}
